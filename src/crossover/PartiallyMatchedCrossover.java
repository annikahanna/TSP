...
public class PartiallyMatchedCrossover implements ICrossover {
    ...
    private ArrayList<Pair> mapping = new ArrayList<Pair>();


    public Tour doCrossover(Tour tour01, Tour tour02) {
        int crossoverpoint1, crossoverpoint2;

        /* Zufällig 2 Crosoverpunkte wählen */
        MersenneTwisterFast rand = new MersenneTwisterFast();
        crossoverpoint1 = rand.nextInt(0, tour01.getCities().size());
        crossoverpoint2 = rand.nextInt(crossoverpoint1, tour01.getCities().size());
        ...
        System.out.println(Arrays.toString(child1.getCities().toArray()) + Arrays.toString(child2.getCities().toArray()));
