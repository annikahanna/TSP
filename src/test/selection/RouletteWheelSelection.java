...
public class RouletteWheelSelection {
    ...
    public void testCalculatePopulationFitness() {
        ...
        Population p = TestTourHelper.getAscendingPopulation(5, 10, true, null);
    ...
    public void testAlreadySelected() {
        ...
        Population p1 = TestTourHelper.getAscendingPopulation(5, 10, true, null);
        Population p2 = TestTourHelper.getAscendingPopulation(1, 10, true, null);
